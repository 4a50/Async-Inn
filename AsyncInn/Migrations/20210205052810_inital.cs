        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "permissions", "addagent", "districtmanager" },
                    { 5, "permissions", "useradd", "districtmanager" },
                    { 6, "permissions", "b", "propertymanager" },
                    { 7, "permissions", "c", "propertymanager" },
                    { 8, "permissions", "agentadd", "propertymanager" },
                    { 9, "permissions", "c", "agent" }
                });
