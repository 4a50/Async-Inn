...
{
    public partial class initialRbuild : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "permissions", "a", "districtmanager" },
                    { 2, "permissions", "b", "districtmanager" },
                    { 3, "permissions", "c", "districtmanager" },
                    { 4, "permissions", "b", "propertymanager" },
                    { 5, "permissions", "c", "propertymanager" },
                    { 6, "permissions", "c", "agent" }
                });
